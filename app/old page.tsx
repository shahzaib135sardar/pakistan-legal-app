...
import { Scale, MessageCircle, Phone, Mail, MapPin, ChevronRight, Globe, Home } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="flex items-start gap-4 p-6 bg-green-50 rounded-lg border border-green-200">
              ...
              <div>
                ...
                <p className="text-green-700 font-medium">info@qanoonforum.pk</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-green-50 rounded-lg border border-green-200">
              ...
              <div>
                ...
                <p className="text-green-700 font-medium">+92-21-111-000-001</p>
              </div>
            </div>
            ...
            <div className="flex items-start gap-4 p-6 bg-green-50 rounded-lg border border-green-200">
              ...
              <div>
                ...
                <p className="text-green-700 font-medium">Karachi, Pakistan</p>
              </div>
            </div>
          </div>
        </div>
